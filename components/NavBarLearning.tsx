              ...
              <NavigationMenuList className="flex space-x-4 p-2 rounded-lg">
                ...
                {/* <NavigationMenuItem>
                  <SignOutButton>
                    <Button
                      variant="ghost"
                      className="text-gray-800 dark:text-white hover:bg-gradient-to-r hover:from-purple-500 hover:to-cyan-500 hover:text-white dark:hover:bg-gradient-to-r dark:hover:from-purple-300 dark:hover:to-cyan-300 dark:hover:text-white"
                    >
                      Sign Out
                    </Button>
                  </SignOutButton>
          ...
          >
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white dark:bg-gray-800 rounded-md shadow-lg">
              ...
              {/* <SignOutButton>
                <Button
                  variant="ghost"
                  className="w-full text-left px-3 py-2 text-sm font-medium text-gray-800 dark:text-white hover:bg-blue-100 dark:hover:bg-gray-700"
                >
                  Sign Out
                </Button>
              </SignOutButton> */}
