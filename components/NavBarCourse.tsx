...
const navItems = [
  { name: 'Frontend', path: '/courses' },
  { name: 'Backend', path: '/courses' },
  { name: 'CyberSecurity', path: '/courses' },
  { name: 'DevOps', path: '/courses' },
  { name: 'Spring', path: '/courses' },
];
...
export default function NavbarCourse() {
  ...
  return (
    <nav className="top-0 z-40 w-full backdrop-blur supports-[backdrop-filter]:bg-background/60">
