    ...
    return (
        <div className="px-16 py-8">
            <Link href="/blog" passHref>
                <Button variant="ghost" className="pb-8 text-black hover:text-blue-400 dark:text-white dark:hover:text-blue-300 transition-colors">
            ...
            <div className="space-y-8">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-8">
                        ...
                        <div className="flex items-center justify-between text-gray-700">
                            <div className="flex items-center space-x-4">
                                ...
                                <time className="text-gray-300" dateTime={post.date}>{formattedDate}</time>
                            </div>
                ...
                <div className="grid md:grid-cols-[1fr_280px] gap-8">
                    <article className="space-y-6">
                        ...
                        <div className="flex items-center justify-between py-6">
                            <div className="flex space-x-4">
                                <button className="flex items-center space-x-2 text-gray-500 dark:text-gray-400 hover:text-cyan-400 dark:hover:text-cyan-400 transition-colors">
                                    <FaShare />
                                    <span>Share</span>
                                </button>
                                <button className="flex items-center space-x-2 text-gray-500 dark:text-gray-400 hover:text-cyan-400 dark:hover:text-cyan-400 transition-colors">
                    ...
                    <aside className="space-y-6">
                        ...
                        <Card className="bg-white dark:bg-gray-800 shadow-md border border-gray-200 dark:border-gray-700">
                            <CardContent className="p-6">
                                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Related Posts</h3>
