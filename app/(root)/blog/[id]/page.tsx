    ...
    return (
        <div className="px-4 md:px-16 py-8 bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
            <Link href="/blog" passHref>
                <Button variant="ghost" className="pb-8 text-gray-900 dark:text-gray-100 hover:text-blue-400 dark:hover:text-blue-400 transition-colors">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 md:p-8">
                        ...
                        <div className="flex flex-col md:flex-row items-start md:items-center justify-between text-gray-600 dark:text-gray-400">
                            <div className="flex items-center space-x-4">
                                ...
                                <time className="text-gray-500 dark:text-gray-300" dateTime={post.date}>{formattedDate}</time>
                            </div>
