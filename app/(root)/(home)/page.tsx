...
export const metadata: Metadata = {
    title: "NakTech",
    description: "Welcome to my portfolio, where I showcase my skills and experiences in software development, cloud engineering, and DevOps. I'm passionate about building scalable and efficient systems that meet the needs of users.",
    keywords: [
        "naktech portfolio",
